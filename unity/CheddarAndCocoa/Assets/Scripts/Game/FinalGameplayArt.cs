...
namespace CheddarAndCocoa.Game
{
    ...
    public static class FinalGameplayArt
    {
        ...
        public const string BabyBirdChickFalling = Root + "/Characters/BabyBirdBedlam/chick_falling";
        public const string BabyBirdChickGrounded = Root + "/Characters/BabyBirdBedlam/chick_grounded";
        public const string BabyBirdChickGrabbed = Root + "/Characters/BabyBirdBedlam/chick_grabbed";
        public const string BabyBirdChickShaking = Root + "/Characters/BabyBirdBedlam/chick_shaking";
        public const string BabyBirdChickGulped = Root + "/Characters/BabyBirdBedlam/chick_gulped";
        public const string BabyBirdChickPecked = Root + "/Characters/BabyBirdBedlam/chick_pecked";
        public const string BabyBirdMotherCircling = Root + "/Characters/BabyBirdBedlam/mother_circling";
        public const string BabyBirdMotherWarning = Root + "/Characters/BabyBirdBedlam/mother_warning";
        public const string BabyBirdMotherAttacking = Root + "/Characters/BabyBirdBedlam/mother_attacking";
        public const string BabyBirdMotherRepelled = Root + "/Characters/BabyBirdBedlam/mother_repelled";
        public const string BabyBirdMotherRescue = Root + "/Characters/BabyBirdBedlam/mother_rescue";
        public const string BabyBirdMotherDefeated = Root + "/Characters/BabyBirdBedlam/mother_defeated";
