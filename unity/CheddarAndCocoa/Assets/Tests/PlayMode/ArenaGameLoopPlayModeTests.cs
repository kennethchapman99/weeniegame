...
namespace CheddarAndCocoa.Tests
{
    public sealed class ArenaGameLoopPlayModeTests
    {
        ...
        public IEnumerator MissionFlow_Select_StartsEveryMission_AndEndActionsNavigate()
        {
            ...
            // The selector is rendered as two columns (19 missions, rows = ceil(19/2) = 10: column 0 holds
            // indices 0-9, column 1 holds 10-18). Directional navigation must match that visible grid
