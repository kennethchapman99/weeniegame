...
- Two new small personality beats (2026-07-05, purely ambient, no gameplay effect): Cocoa gets a
  brief glow-and-proud-pose when she's stood still for a few seconds ("she owns that sunbeam now"),
  and the squirrel occasionally gets a quiet muttering pulse when it isn't actively stealing (its
  unintelligible villain monologue). Log it in the Laugh Log if anyone notices or comments on either
