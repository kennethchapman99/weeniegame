...
>   de-skunk co-op scramble.
> - [`LEVEL-IDEA-BURR-MAZE.md`](LEVEL-IDEA-BURR-MAZE.md), **Burr Maze — Operation Sticky Coat**
>   (2026-07-22) — a top-down tactical-stealth maze with bird patrols, noisy hazards, mutual
>   grooming, and an escalating "more burrs cause more burrs" coat-snag system.
>
> Both concepts remain deferred until the mission roster is explicitly unfrozen.
