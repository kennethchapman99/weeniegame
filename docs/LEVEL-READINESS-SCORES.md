...
| 26 | Burr Maze | 4 | 3 | 3 | The roster's first patrol-stealth puzzle: a facing-direction vision cone with a brief notice-dwell, a stealth-retry detection (position-only reset, a genuinely distinct third failure pattern from Skunk/Tick), asymmetric burr accrual with a real speed-penalty/wider-notice caked state, a partner-held burr-pick, hiding-spot dwell resets, a bark-lure, and an independent twist patrol give it a real stealth identity; hiding bushes and bramble patches reuse existing Bush/Grass prop art, the cat/kitten patrol on the shared/generated predator actor (no bespoke sprite yet), and the mission tile is a generated greybox placeholder, not painterly art. |
